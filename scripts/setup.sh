...
curl -u 'AleksiNummelin' https://api.github.com/user/repos -d '{"name":"coupled_channel", "private":false}'
...
git remote add origin git@github.com:AleksiNummelin/coupled_channel.git
